function  tracksReform = removeMerge2SplitClustHistOldVersion(clustHistoryAll,tracksIn,probArtifactMerge2split)
...
%                 seqOfEvents(seqOfEvents(:,3)==segmentSplit,3)=NaN;
%                 seqOfEvents(seqOfEvents(:,4)==segmentSplit,4)=NaN;
...
%                 
                ...
                seqOfEvents([rowMerge,rowSplit],4)=NaN;
