/*
 * Compilation:
 * Mac/Linux: mex neg2LnLikelihoodMultiNodeMEX.c
 * Windows: mex COMPFLAGS="$COMPFLAGS /TP /MT" -output neg2LnLikelihoodMultiNodeMEX neg2LnLikelihoodMultiNodeMEX.cpp
 */
