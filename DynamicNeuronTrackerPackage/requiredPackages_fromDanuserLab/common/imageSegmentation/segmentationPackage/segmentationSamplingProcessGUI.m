function varargout = segmentationSamplingProcessGUI(varargin)
% segmentationSamplingProcessGUI M-file for segmentationSamplingProcessGUI.fig
%      segmentationSamplingProcessGUI, by itself, creates a new segmentationSamplingProcessGUI or raises the existing
%      singleton*.
%
%      H = segmentationSamplingProcessGUI returns the handle to a new segmentationSamplingProcessGUI or the handle to
%      the existing singleton*.
%
%      segmentationSamplingProcessGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in segmentationSamplingProcessGUI.M with the given input arguments.
%
%      segmentationSamplingProcessGUI('Property','Value',...) creates a new segmentationSamplingProcessGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segmentationSamplingProcessGUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segmentationSamplingProcessGUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segmentationSamplingProcessGUI
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @segmentationSamplingProcessGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @segmentationSamplingProcessGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segmentationSamplingProcessGUI is made visible.
function segmentationSamplingProcessGUI_OpeningFcn(hObject,eventdata,handles,varargin)
...
samplableInput = SegmentationSamplingProcess.getSamplableInput;
...
% Choose default command line output for segmentationSamplingProcessGUI
...
function varargout = segmentationSamplingProcessGUI_OutputFcn(~, ~, handles) 
